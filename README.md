...
### 🗂️ Репозитории - визитки:

* 💳 [FinTech Data Platform: ETL, DWH (Vertica)](https://github.com/Ibndaud/de-project-final)
* 🍕 [Restaurant Subscribe Streaming Service](https://github.com/Ibndaud/de-project-sprint-8)
* 🧠 [ООП на Python: от ужаса до понимания](https://github.com/Ibndaud/oop-in-python-from-terror-to-understanding)
* 🔄 [karpov.courses - Управление моделями - Версионирование данных (DVC)](https://github.com/Ibndaud/dvc)
